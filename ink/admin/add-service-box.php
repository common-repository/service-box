				...
				if($TotalCount!=-1)
				{
					foreach($data as $single_data)
					{
						...
						<li class="wpsm_ac-panel single_acc_box" >
							...
							<input type="text" id="service_title[]" name="service_title[]" value="<?php echo esc_attr($service_title); ?>" placeholder="Enter Faq Title Here" class="wpsm_ac_label_text">
							<span class="ac_label"><?php _e('Service Small Description',wpshopmart_service_box_text_domain); ?></span>
							<textarea  id="service_description[]" name="service_description[]"  placeholder="Enter Faq Description Here" class="wpsm_ac_label_text"><?php echo esc_html($service_description); ?></textarea>
							
							<span class="ac_label"><?php _e('Service Icon',wpshopmart_service_box_text_domain); ?></span>
							<div class="form-group input-group">
								<input data-placement="bottomRight" id="service_icon[]" name="service_icon[]" class="form-control icp icp-auto" value="<?php echo esc_attr($service_icon); ?>" type="text" readonly="readonly" />
							...
							<span class="ac_label"><?php _e('Add Your Service Link Or Read More Link Here (With http://or https://)',wpshopmart_service_box_text_domain); ?></span>
								...
								<input type="text" id="service_link[]" name="service_link[]" value="<?php echo esc_attr($service_link); ?>" placeholder="Enter Service Link Here" class="wpsm_ac_label_text">		
			...
			else 
			{
				  for($i=1; $i<=2; $i++)
				  {
					 ...
					 <li class="wpsm_ac-panel single_acc_box" >
							...
							<span class="ac_label"><?php _e('Service Small Description',wpshopmart_service_box_text_domain); ?></span>
							<textarea  id="service_description[]" name="service_description[]"  placeholder="Enter Service Description Here" class="wpsm_ac_label_text"><?php esc_html_e('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec feugiat.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec feugiat.',wpshopmart_service_box_text_domain); ?></textarea>
